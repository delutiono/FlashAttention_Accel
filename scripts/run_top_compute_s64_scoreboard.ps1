param(
  [string]$WorkLib = "work_top_compute_s64_scoreboard",
  [string]$VectorDir = "artifacts/vectors/s64_d64_seed104",
  [string]$BuildDir = "build/top_compute_s64",
  [string]$CaseName = "s64_d64_seed104",
  [int]$Seed = 104,
