...
wire [5:0] q_port_addr = q_ext_valid ? q_ext_addr : q_load_addr;
...
assign q_rd_addr = phase_active_reg ?
    {1'b0, phase_q_page_reg, phase_q_row_reg, 1'b1} :
    {1'b0, in_q_page, in_q_row, 1'b0};
assign k_rd_addr = phase_active_reg ?
    {1'b0, phase_k_page_reg, phase_k_row_reg, 1'b1} :
    {1'b0, in_k_page, in_k_row, 1'b0};
