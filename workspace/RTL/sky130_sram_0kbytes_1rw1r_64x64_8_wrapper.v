...
module sky130_sram_0kbytes_1rw1r_64x64_8_wrapper (
    input  wire        clk,
    input  wire        rst_n,
    input  wire        rw_en,
    input  wire        rw_write,
...
sky130_sram_0kbytes_1rw1r_64x64_8 u_mem (
...
// Macro synchronous read plus this output register form the 2-cycle contract.
