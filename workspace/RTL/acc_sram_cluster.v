...
// 64x64x12 ACC store built from twelve 64x64 PDK-compatible wrappers.
// Address encoding is {context[2:0], quarter[2:0]}; one access covers 16 signed lanes.
...
generate
    for (bank_idx = 0; bank_idx < 12; bank_idx = bank_idx + 1) begin : g_bank
        sky130_sram_0kbytes_1rw1r_64x64_8_wrapper u_bank (
            .clk(clk),
            .rst_n(rst_n),
            .rw_en(wr_en),
            .rw_write(1'b1),
