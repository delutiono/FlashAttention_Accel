...
module fa_dot_pe #(
  ...
  input  logic signed [ELEM_W-1:0] q_i [LANES],
  input  logic signed [ELEM_W-1:0] k_i [LANES],
  ...
  logic signed [31:0] mul_stage [LANES];
  logic               valid_mul;
  logic               clr_mul;
